...
<body>
      <div class="container d-flex justify-content-center">
        ...
        <div class="col-md-6">
            <h2 class="form-title text-center">Nous contacter</h2>
            <p class="justify text-muted text-center">Avez-vous besoins d'un guide dev?<br>Veuillez bien nous contacter.</p>
            <form>
